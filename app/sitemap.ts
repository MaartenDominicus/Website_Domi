...
import { projectsNl } from "./project-data";
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const projects = projectsNl.flatMap(({ slug }) => [
    { url: `https://troosbouw.com/projecten/${slug}`, lastModified, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `https://troosbouw.com/en/projects/${slug}`, lastModified, changeFrequency: "monthly" as const, priority: 0.7 },
  ]);
